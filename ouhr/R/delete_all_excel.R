...
#'
#' Delete existing data from an Excel sheet. Can specify the start column and start row.
#'
...
#' @param col_start A number for the column to start deleting from. Default is 1.
#' @param row_start A number for the row to start deleting from. Default is 1.
#'
#' @return Deletes all the data from the starting row/column specified of the Excel sheet.
#' @export
#'
#' @examples \dontrun{
